<template>
  <Form ref="formItem" :model="formItem" :label-width="80">
    <Card dis-hover class="margin-top-20 large-card">
      ...
      <Row>
        <Col span="11">
        <Form-item label="产品类型列表">
          <Select v-model="formItem.cur_prod" placeholder="预览产品类型">
        ...
        <Form-item label="增加类型" prop="spec">
          <Input v-model="formItem.prod_name" placeholder="请输入类型名称"></Input>
        </Form-item>
